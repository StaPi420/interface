...
def db_load():
    with open('D:\\vscode101\\python_progs\\interface\\miniproject5\\accounts.json', 'r', encoding='utf-8') as f:
        try:
            return json.load(f)
...
def db_dump(obj):
    with open('D:\\vscode101\\python_progs\\interface\\miniproject5\\accounts.json', 'w', encoding='utf-8') as f:
        json.dump(obj, f)

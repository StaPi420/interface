...
from PyQt6.QtWidgets import QMainWindow, QLabel, QPushButton, QApplication, QListWidget, QLineEdit, QComboBox, QLCDNumber
...
class MWindow(QMainWindow):
    def __init__(self):
        ...
        self.question_label.setFixedSize(300, 30) 
        self.question_label.move(75, 50)

        ## line edit
        self.line_edit = QLineEdit(self)
        self.line_edit.setFixedSize(300, 30)
        self.line_edit.move(75, 90)
    ...
    def list1_delete(self):
        ...
        current_question = self.combobox.currentText()
